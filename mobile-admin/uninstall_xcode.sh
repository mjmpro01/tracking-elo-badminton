...
# Script để gỡ cài đặt Xcode hoàn toàn trên macOS

echo "⚠️  CẢNH BÁO: Script này sẽ xóa Xcode và tất cả dữ liệu liên quan!"
echo "Bạn sẽ không thể build iOS app sau khi gỡ cài đặt."
echo ""
